...
public class NewAPI_Homework {
    ...
    public void testGetAllArticleAuthor(){
        ...
        System.out.println(allAuthorsNoFilter.size());
...
// additional requirement -- remove any author with null value
        ...
        System.out.println(allAuthorsWithNoNull.size());
        ...
        List<String> ids= jp.getList("articles.findAll{it.source.id!=null}.source.name");
