...
public class RestAssuredIntro {
    ...
    public void TestHello(){
        ...
        response =  get("http://54.160.160.130:8000/api/hello") ;
    ...
    public void testN(){
        ...
        int succsessStatusCode=200;

        System.out.println("statusCode = " + code);

        assertThat(code,equalTo(succsessStatusCode));
        
        String body=response.prettyPrint();
        //System.out.println("body = " + body);

        assertThat(body,is(response.prettyPrint()));
        ...
        assertThat(response.contentType(),endsWith("8"));
